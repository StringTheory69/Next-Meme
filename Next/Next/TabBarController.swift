...
class TabBarController: UITabBarController, FUIAuthDelegate {
...
struct Contest {
    ...
    init(endTime: Timestamp, prize: Int) {
        self.endTime = endTime.dateValue()
        self.endDate = endTime.dateToElapsedTime()
        self.seconds = Int(endTime.seconds)
        self.prize = prize
    }
